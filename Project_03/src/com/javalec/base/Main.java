...
public class Main {
	...
	public static void main(String[] args) {
		/*
		 * 1. Addition : 덧셈 - 수진 2. AddSub : 덧셈 + 뺄셈 - 광영 3. AddSubMul : 덧셈+뺄셈+곱셈 - 수민
		 * 4. AddSubMulDiv : 덧셈+뺄셈+곱셈+나눗셈 - 채림 5. AddSubMulDivRemainder :
		 * 덧셈+뺄셈+곱셈+나눗셈+나머지 - 대근 6. Main?
		 */
		...
		System.out.println("1. 1번과 2번의 숫자의 합은 " + all.sum2() + "입니다.");
		System.out.println("2. 1번과 3번,4번의 덧셈 뺄셈 곱셈 나눗셈의 결과는 덧셈 : " + all.sum3() + ", 뺄셈 : " + all.subAction()
				+ ", 곱셈 : " + all.mul1Action() + ", 나눗셈 : " + all.div1Action());
		System.out.println();

		System.out.println(">>> Constructor를 사용 하여 Date 전달");
		System.out.println("1. 3번과 4번의 덧셈 뺄셈 곱셈의 결과는 덧셈 : " + all.sum3() + ", 뺄셈 : " + all.sub3Action() + ", 곱셈 : "
				+ all.mul2Action());
		System.out.println("2. 1 2 3번의 뺄셈 곱셈의 결과는 뺄셈 : " + all.sub3Action() + ", 곱셈 : " + all.mul3Action());
		System.out.println();

		System.out.println(">>> Method를 사용 하여 Date 전달");
		System.out.println("1. 1 2 4번의 덧셈 뺄셈 곱셈 나눗셈 나머지의 결과는 덧셈 : " + all.sum3() + ", 뺄셈 : " + all.sub4Action()
				+ ", 곱셈 : " + all.mul4Action() + ", 나눗셈 : " + all.div4Action() + ", 나머지 : " + all.allAction());
